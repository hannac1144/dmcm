...
const pathways = {
  technology: {
    ...
    questions: [
      ...
      { id: 'legalStructure', title: 'What is your legal structure?', prompt: 'Select the legal structure that best describes the entity that will own, license, develop, or commercialize the technology.', options: [['LLC — Limited Liability Company', 'llc'], ['LLP — Limited Liability Partnership', 'llp'], ['LP — Limited Partnership', 'lp'], ['General partnership', 'general-partnership'], ['C corporation', 'c-corp'], ['S corporation', 's-corp'], ['Professional corporation (PC)', 'pc'], ['Professional limited liability company (PLLC)', 'pllc'], ['Nonprofit corporation', 'nonprofit'], ['Sole proprietorship', 'sole-proprietorship'], ['Benefit / public benefit corporation', 'benefit-corp'], ['Public / governmental entity', 'government'], ['University / research institution', 'university-entity'], ['Hospital / health system', 'hospital-entity'], ['Other legal structure', 'other-legal']] },
  ...
  drug: {
    ...
    questions: [
      ...
      { id: 'legalStructure', title: 'What is your legal structure?', prompt: 'Select the legal structure that best describes the entity that will own, license, develop, or commercialize the therapeutic program.', options: [['LLC — Limited Liability Company', 'llc'], ['LLP — Limited Liability Partnership', 'llp'], ['LP — Limited Partnership', 'lp'], ['General partnership', 'general-partnership'], ['C corporation', 'c-corp'], ['S corporation', 's-corp'], ['Professional corporation (PC)', 'pc'], ['Professional limited liability company (PLLC)', 'pllc'], ['Nonprofit corporation', 'nonprofit'], ['Sole proprietorship', 'sole-proprietorship'], ['Benefit / public benefit corporation', 'benefit-corp'], ['Public / governmental entity', 'government'], ['University / research institution', 'university-entity'], ['Hospital / health system', 'hospital-entity'], ['Other legal structure', 'other-legal']] },
      { id: 'state', title: 'Which state are you operating in?', prompt: 'Select the state whose licensing and healthcare-regulatory rules should be included in your issue-spotting review.', options: states.map(state => [state, state]) },
...
function downloadPDF({ pathway, answers }) {
  ...
  pathways[pathway].questions.forEach(question => {
    ...
    if (value) {
      const selected = question.options.find(([, optionValue]) => optionValue === value);
      addText(`${question.title}: ${selected ? selected[0] : value}`, 10, false, 4);
    }
  });
  ...
  addHeading('How to move forward');
  addText('Recommended next steps include confirming ownership and entity authority, identifying appropriate non-dilutive funding programs and strategic partners, building a targeted investor list, and assembling IP, transactional, regulatory, clinical, and manufacturing advisors as applicable.', 9, false, 7);
  addText('Funding starting points: NIH SBIR/STTR, NSF America’s Seed Fund, BARDA DRIVe, and ARPA-H should be screened based on eligibility and the current solicitation. Healthcare-focused investors such as SV Health Investors and HealthQuest Capital may also be relevant depending on asset type and stage.', 9, false, 7);
